//we could define multiple classes within a single java file 
//all we need to do is initialize the name of the whole file with the single class
//among those, and which contains the public static void main(String[] args)
